...
<div class="container">
    ...
    <div class="form-control position-relative">
        <label for="food-code">Mã sảnh</label>
        <input type="text" id="food-code" class="form-control" disabled>

        <label for="food-name">Tên thức ăn <span class="text-danger">*</span> </label>
        <input type="text" id="food-name" class="form-control" aria-describedby="passwordHelpBlock" >

        <label for="food-status">Trạng thái <span class="text-danger">*</span> </label>
        <select class="form-select" id="food-status" >
            <option selected >Chọn trạng thức ăn</option>
...
<script src="<c:url value="/js/admin/update-food.js"/>"></script>
