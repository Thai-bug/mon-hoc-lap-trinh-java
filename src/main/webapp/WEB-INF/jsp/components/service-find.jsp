            ...
            <div class="rounded-t mb-0 px-4 py-3 border-0">
                <div class="flex flex-wrap items-center">
                    <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                        <h3 class="font-semibold text-base text-blueGray-700">Danh sách dịch vụ</h3>
                    </div>
                    <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                        <a href="<c:url value="/admin/services/add"/>"
                    ...
                    <c:forEach var="e" items="${services}">
                        <tr>
                            ...
                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                <a href="<c:url value="/admin/services/detail/${e.id}"/>">
                                        ${e.name}
                                </a>
                            </td>
                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
            ...
            <div class="flex text-gray-700">
                ...
                <div class="flex h-8 font-medium ">
                    <c:forEach begin="1" var="i" end="${Math.ceil(total/5)}">
                        <a href="<c:url value="/admin/services?page=${i}" />"
