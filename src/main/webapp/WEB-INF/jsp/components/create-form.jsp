...
<div class="relative flex justify-around bg-gray w-full mb-6 shadow-lg rounded p-8">
    <div class="rounded  bg-transparent " id="avatar-user">
        <img class="w-auto mx-auto h-64 object-cover object-center" src="<c:url value="/images/default-avatar.jpeg"/>" alt="avatar"
    ...
    <div class="w-7/12">
        ...
        <div>
            <form:form modelAttribute="employee" method="post" enctype="multipart/form-data" action="${action}" autocomplete="off">
                ...
                <div class="form-control grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <form:input path="email" placeholder="Email" cssClass="input input-bordered w-full" autocomplete="false"/>
                        <form:errors path="email" cssClass="text-red-500 text-sm" element="div"/>
                    </div>
                    ...
                    <div class="">
                        ...
                        <form:input path="password" cssClass="input input-bordered w-full" type="password" autocomplete="false"/>
                    </div>
                    <div class="">
                        <label class="label">
