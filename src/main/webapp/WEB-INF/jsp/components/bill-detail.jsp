...
<div id="main" class="hidden bg-gray-200 rounded-xl m-16 leading-loose p-4">
    ...
    <div class="grid grid-cols-2 gap-x-16 gap-y-4">
        <div>
            <div class="text-sm mb-2">Mã đơn hàng</div>
            <input id="code" class="border-gray-400 border rounded-xl w-3/4" disabled/>
        </div>

        <div>
            <div class="text-sm mb-2">Họ và tên khách hàng:</div>
            <input id="customer-name" class="border-gray-400 border rounded-xl w-3/4 capitalize" disabled/>
        </div>

        <div>
            <div class="text-sm mb-2">Tên bữa tiệc:</div>
            <input id="name" class="border-gray-400 border rounded-xl w-3/4 capitalize" disabled/>
        </div>

        <div>
            <div class="text-sm mb-2">Nhân viên sale:</div>
            <input id="employee" class="border-gray-400 border rounded-xl w-3/4 capitalize" disabled/>
        </div>

        <div>
            <div class="text-sm mb-2">Tên sánh:</div>
            <input id="lobby" class="border-gray-400 border rounded-xl w-3/4 capitalize" disabled/>
        </div>

        <div>
            <div class="text-sm mb-2">Thời gian bắt đầu:</div>
            <input id="beginDate" class="border-gray-400 border rounded-xl w-3/4 capitalize" disabled/>
        </div>
