        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded"
            ...
            <div class="rounded-t mb-0 px-4 py-3 border-0">
                <div class="flex flex-wrap items-center">
                    <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                        <h3 class="font-semibold text-base text-blueGray-700">Danh sách sảnh tiệc</h3>
                    </div>
                    <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                        <a href="<c:url value="/admin/lobby/create"/>"
            ...
            <div class="block w-full overflow-x-auto">
                <table class="items-center bg-transparent w-full border-collapse ">
                    ...
                    <tbody>
                    <c:forEach var="e" items="${lobbies}">
                        <tr>
                            <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left text-blueGray-700 ">
                                    ${e.id}
                            </th>
                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                <a href="<c:url value="/admin/lobby/${e.id}"/>">
                                        ${e.name}
                                </a>
                            </td>
                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
            ...
            <div class="flex text-gray-700">
                ...
                <div class="flex h-8 font-medium ">
                    <c:forEach begin="1" var="i" end="${Math.ceil(total/5)}">
                        <a href="<c:url value="/admin/lobbies?page=${i}" />"
